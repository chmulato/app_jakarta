...
![Capa do projeto: automação de build e deploy](./doc/img/article-i.png)
...
![Fluxo geral: banco, build, deploy e login](./doc/img/article-ii.png)
...
![Página inicial do sistema no Tomcat (porta 9090)](./doc/img/index-tomcat-9090.png)
...
![Página inicial do sistema no WildFly (porta 8080)](./doc/img/index-wildfly-8080.png)
